...
<div class="form-add-menu modal-form-add">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-4 col-sm-6 col-xs-12">
            ...
            <textarea placeholder="Mô tả" style="height: 35px; max-width: 100%; min-height: 35px; min-width: 100%"
                      id="cat_home_desc">{{ obj['desc'] }}</textarea>
        </div>
        <div class="form-group col-md-4 col-sm-6 col-xs-12">
            <label style="font-size: 20px; padding-top: 5px; font-weight: 100">Vị trí </label>
            <input type="text" name="data[sort]" class="form-control" id="cat_home_sort" value="{{ obj['sort'] }}"
                   placeholder="Vị trí">
        </div>
    </div>
