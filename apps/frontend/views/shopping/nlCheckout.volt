...
<div class="container mt-3">
    <div class="row">
        <div class="checkout">
            <div class="col-12 col-md-12 payment-header text-center text-white bg-primary py-2">
            ...
            <div class="col-12 col-md-12">
                ...
                <div class="payment-form">
                    <form name="NLpayBank" action="/service/nlCheckout" method="post">
                        ...
                        <input type="hidden" name="package_name" value="{{ package_service['name'] }} - {{ package_option['package_name'] }}">
                        <input type="hidden" name="package_option_price" value="{{ package_option['price'] }}">
                        <input type="hidden" name="order_id" value="{{ order_id }}">

                        <div class="row">
                            <div class="col-12 text-center"><strong class="text-danger" style="font-size: 17px; float: left; line-height: 40px;">THÔNG TIN HÓA ĐƠN</strong></div>
                            <div class="table-responsive">
                                <table class="table">
                                    <tbody>
                                    <tr>
                                        <th scope="row">Gói dịch vụ:</th>
                                        <td>{{ package_service['name'] }} - {{ package_option['package_nam  e'] }}</td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Giá:</th>
