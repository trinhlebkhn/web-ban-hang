        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <div class="logo pull-left">
                    <a class="navbar-brand" href="index.html"> <img alt="Lambda Theme - Shop" src="{{ websiteConfig['avatar'] is not empty? websiteConfig['avatar'] : resourcePAth~'assets/images/shop/lambda-shop.png' }}"> </a>
                </div>
                <div class="logo-sidebar"></div>
                <div class="menu-sidebar pull-right">
                    <div class="sidebar-widget text-right small-screen-center widget_search">
                        <form action="{{ Current_link is not empty ? Current_link : 'tim-kiem.html' }}" method="get" name="searchform">
                            <div class="input-group"><input class="form-control" id="query" name="strSearch" placeholder="Tìm kiếm......"
                                                            value="{{ strSearch is not empty ? strSearch : '' }}" type="text">
        ...
        <div class="nav-container clearfix box-menu">
            <nav class="collapse navbar-collapse main-navbar">
                ...
                <div class="menu-sidebar form-search">
                    <div class="sidebar-widget text-right small-screen-center widget_search">
                        <form action="{{ Current_link is not empty ? Current_link : 'tim-kiem.html' }}" method="get" name="searchform">
                            <div class="input-group"><input class="form-control" id="query" name="strSearch" placeholder="Tìm kiếm......" type="text"
